...
namespace Buoi1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("--------------------------------------------------------------------|");
                Console.WriteLine("Menu bai tap tren lop:");
                Console.WriteLine("1. Nhap 2 so tinh tong hieu tich thuong");
                Console.WriteLine("2. Nhap thong tin mot sinh vien ");
                Console.WriteLine("3. Tao n phan tu bang sinh so ngau nhien va xuat ra man hinh");
                Console.WriteLine("4. Chuong trinh giai bac 1");
                Console.WriteLine("5. Chuong trinh giai bac 2");
                Console.WriteLine("6. Cho biet ngay nhap vao thu may ?");
                Console.WriteLine("7. Phan tich n ra thua so nguyen to / Cho biet n co bao nhieu chu so");
                Console.WriteLine("------------------------------------------------------------------|");
                Console.WriteLine("Menu bai tap ve nha :");
                Console.WriteLine("8. Cho nhap so phai la so chinh phuong, xuat so vua nhap");
                Console.WriteLine("9. Nhap ngay thang nam, cho biet ngay truoc va sau la ngay may");
                Console.WriteLine("10. Tao day so nguyen to random 20 so. Thuc hien cac yeu cau");
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        {
                            Console.WriteLine("Nhap so phan tu day so : ");
                    ...
                    case 8:
                        {
                            ...
                            {
                                Console.WriteLine("So nhap la so chinh phuong");
                            }
                            else
                            {
